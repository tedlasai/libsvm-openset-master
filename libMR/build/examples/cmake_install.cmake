...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/tedlasai/Dropbox/SAITEDLA/School/UCCS/Lab/2015/LIBSVm/libsvm-openset-master/libMR/build/examples/wbl-test")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/wbl-test" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/wbl-test")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/wbl-test"
         OLD_RPATH "/home/tedlasai/Dropbox/SAITEDLA/School/UCCS/Lab/2015/LIBSVm/libsvm-openset-master/libMR/build/libMR:"
         NEW_RPATH "")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/tedlasai/Dropbox/SAITEDLA/School/UCCS/Lab/2015/LIBSVm/libsvm-openset-master/libMR/build/examples/mr-test")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/mr-test" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mr-test")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mr-test"
